...
public class MainClassForProgram extends JFrame{
	...
	public static void go() {
		...
		frame.add(MainClassForProgram.createPanels());
...
class CreateButtonAction extends AbstractAction{
	...
	public void actionPerformed(ActionEvent e) {
		MainClassForProgram.scrollPanel.add(createCell("ВКонтакте", "qwerty123TFa345"));
